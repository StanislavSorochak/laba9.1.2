...
int main()
{
	...
	int kil_student;
	cout << "Кількість студентів: "; cin >> kil_student;
	cout << endl;
	...
	cout << "Процент студентів, які вчаться без трійок (на “відмінно” і “добре”): " << setprecision(2) << find_studend(s, kil_student) << "%" << endl << endl;
